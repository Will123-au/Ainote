        ...
        <div className="setting-item">
          <div className="setting-item-info">
            ...
            <div className="setting-item-description">
              Restore the default plugin templates (meeting_note.md, youtube_video.md, enhance.md, enhance_preserve_media.md, research_paper.md, flash_cards.md) to their original versions. Your custom templates will not be affected.
            </div>
          </div>
          <div className="setting-item-control">
            <button
